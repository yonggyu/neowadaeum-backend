 ...
 *
 * <p><b>미리보기 3턴이 없다.</b> 미리보기는 <b>다른 작품</b>을 만든다 (§13-5) — 임시
 * {@code draft} · {@code private} 작품과 그 세션이며, 제출은 그것과 별개의 작품을 발행한다.
 * 검수 대상 작품에서 그 턴으로 가는 길이 없고, 있는 척하는 필드를 두면 <b>계약이 거짓말을
 * 시작한다.</b>
 *
...
public record ReviewManuscript(UUID storyId, String title, String shortDesc, String worldIntro,
		...
		List<ManuscriptEnding> endings, AutoCheckSummary autoCheck) {
