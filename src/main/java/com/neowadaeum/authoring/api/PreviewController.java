...
public class PreviewController {
	...
	/** §13-81 — 같은 이유로 크기도 다시 본다 (#380). 재는 축이 다르다. */
	...
	public PreviewController(DraftService drafts, DraftVocabularyGate vocabulary,
			DraftScaleGate scale, StoryPublisher publisher, TestSessionStarter sessions,
			RateLimiter rateLimiter, PlayerRefResolver playerRefs, UgcLimitProperties limits) {
		this.drafts = drafts;
	...
	public PreviewResponse preview(@PathVariable UUID draftId) {
		...
		// §13-81 — 크기도 같은 자리에서 본다 (#380). 게이트가 붙기 전에 저장된 원고가 여기로 온다.
