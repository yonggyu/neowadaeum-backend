...
>
> **이후 추가 (v1.3)** — §8.1 의 Draft → Ready 조건에 "프로젝트 위키 갱신" 한 줄이 늘었다.
> 그 규칙의 정본은 `CLAUDE.md` 의 "프로젝트 위키" 절이며, 여기는 조건 목록에서 그것을 가리키기만 한다.
>
...
- [ ] **프로젝트 위키를 갱신했다 — 또는 갱신할 것이 없음을 PR 본문에 적었다** (`CLAUDE.md` "프로젝트 위키" 절)
