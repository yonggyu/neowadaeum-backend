...
| `docs/deployment.md` | 이미지 · 마이그레이션 순서(expand-contract) · 무중단 배포 · 롤백 (B-63) |
| `docs/releases.md` | **릴리스 조합 원장.** 어느 프론트 태그와 어느 백엔드 태그가 함께 검증됐는가. 번호는 두 레포가 각자 센다 (§13-92) |
| `docs/runbook/` | 장애 대응. Provider 장애 · 세이프티 오탐 · 비용 폭주 · 유출 (B-64) |
